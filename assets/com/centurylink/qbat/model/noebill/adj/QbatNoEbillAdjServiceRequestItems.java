...
@ApiModel(value = "QbatNoEbillAdjServiceRequestItems", description="QbatNoEbillAdjServiceRequestItems")
public class QbatNoEbillAdjServiceRequestItems  implements Jsonable
{
     ...
     * 
     */
    public QbatNoEbillAdjServiceRequestItems(JSONObject json) {
    	 bind(json);  
    }
	public QbatNoEbillAdjServiceRequestItems(String prefix, String btn, String customerCode, String suffix,
